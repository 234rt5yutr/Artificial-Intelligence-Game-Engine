...
* [ ]  Step 16.1: Add a lightweight UI rendering library (like `RmlUi` or a custom Signed-Distance Field text renderer) to draw HUD elements independently of the 3D scene.
